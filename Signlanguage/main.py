...
def process():
    ...
    while(True):
        ...
        cv2.putText(img,"Legend:",(690,160),font,1,(255,255,255),1)
        cv2.putText(img,"s-Speech",(690,190),font,1,(255,255,255),1)
        cv2.putText(img,"a-append",(690,220),font,1,(255,255,255),1)
        cv2.putText(img,"p-space",(690,250),font,1,(255,255,255),1)
        cv2.putText(img,"x-Delete",(690,280),font,1,(255,255,255),1)
        cv2.putText(img,"X-Clear",(690,310),font,1,(255,255,255),1)
        ...
        if(predicted_char != 'None'):
            ...
            cv2.putText(img, str(predicted_char), (250,250),font,6,color,7)
        scribble = "".join(str(item) for item in sentence_raw)
        ...
        if k == ord('x'):
            ...
            language = 'kn'
            output = gTTS(text=sente1, lang = language, slow = True)
